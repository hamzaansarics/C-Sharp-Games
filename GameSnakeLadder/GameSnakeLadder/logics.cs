   ...
   public  class logics
    {
        ...
        public static int rolldice(PictureBox px)
        {
            ...
            Random g = new Random();
            dice = g.Next(1, 7);
            px.Image = Image.FromFile(@"G:\Study\Practice Program\#Window_Form\GameSnakeLadder\GameSnakeLadder\Resources\" + dice + ".png");
            return dice;
        }

        public void move(ref int x, ref int y, ref int p, int dice,PictureBox ss, Label pp, ref int[] pos,Label ja)
        {
            if (dice + p > 100)
            {
                pp.Text = "Can't Move";
        ...
        public void moveage(ref int s, ref int n, ref int r, int dice, PictureBox ss, Label pp, ref int[] pos,Label jj)
        {
            if (dice + r > 100)
            {
                pp.Text = "Can't Move";
